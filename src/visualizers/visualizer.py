...
class Visualizer:
    ...
    def header(self, root):
        ...
        export_btn = tk.Button(header, text="Exportieren", width=10, bg="#cccccc", highlightthickness=0, highlightbackground="#e9e9e9", borderwidth=0, font=("Arial", 13))
        ...
        start_date_input = tk.Entry(header, width=10, bg="#cccccc", highlightthickness=0, highlightbackground="#e9e9e9", borderwidth=0, font=("Arial", 13), justify="center")
        start_date_input.place(relx=0.28, rely=0.5, height=50, anchor="center")
        end_date_input = tk.Entry(header, width=10, bg="#cccccc", highlightthickness=0, highlightbackground="#e9e9e9", borderwidth=0, font=("Arial", 13), justify="center")
        ...
        dropdown.config(width=20, bg="#cccccc", highlightthickness=0, highlightbackground="#e9e9e9", borderwidth=0, font=("Arial", 13))
