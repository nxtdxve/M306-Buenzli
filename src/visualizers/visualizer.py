...
class Visualizer:
    ...
    def check_dates(self, start_date_day, start_date_month, start_date_year, end_date_day, end_date_month,
        ...
        """
        date_list = [start_date_year.get(), start_date_month.get(), start_date_day.get(), end_date_year.get(), end_date_month.get(), end_date_day.get()]
        start_date_day.bind("<<ComboboxSelected>>", lambda event: self.validate_date(start_date_year, start_date_month, start_date_day, end_date_year, end_date_month, end_date_day))
        print(start_date_day.get())
        start_date_month.bind("<<ComboboxSelected>>", lambda event: self.validate_date(start_date_year, start_date_month, start_date_day, end_date_year, end_date_month, end_date_day))
        print(start_date_month.get())
        start_date_year.bind("<<ComboboxSelected>>", lambda event: self.validate_date(start_date_year, start_date_month, start_date_day, end_date_year, end_date_month, end_date_day))
        print(start_date_year.get())
        end_date_day.bind("<<ComboboxSelected>>", lambda event: self.validate_date(start_date_year, start_date_month, start_date_day, end_date_year, end_date_month, end_date_day))
        print(end_date_day.get())
        end_date_month.bind("<<ComboboxSelected>>", lambda event: self.validate_date(start_date_year, start_date_month, start_date_day, end_date_year, end_date_month, end_date_day))
        print(end_date_month.get())
        end_date_year.bind("<<ComboboxSelected>>", lambda event: self.validate_date(start_date_year, start_date_month, start_date_day, end_date_year, end_date_month, end_date_day))
